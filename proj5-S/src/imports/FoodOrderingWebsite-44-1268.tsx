import svgPaths from "./svg-afpsnibr3h";
...
function Button5() {
  return (
    <div className="bg-[#f5f5f5] h-[37px] relative rounded-[40px] shrink-0 w-[87.5px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-[44px] not-italic text-[#606060] text-[14px] text-center top-[7.6px]">Pending</p>
      </div>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="h-[24px] relative shrink-0 w-[132.463px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101010] text-[16px] top-[-0.6px]">Gramercy Tavern</p>
      </div>
    </div>
  );
}
...
function Text() {
  return (
    <div className="h-[18px] relative shrink-0 w-[18.663px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#101010] text-[12px] top-[-0.2px]">4.8</p>
      </div>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="h-[18px] relative shrink-0 w-[36.663px]" data-name="Container">
...
function Container14() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[24px] items-center left-0 top-0 w-[931.1px]" data-name="Container">
      <Heading1 />
      <Container15 />
    </div>
  );
...
function Paragraph6() {
  return (
    <div className="absolute h-[18px] left-0 top-[28px] w-[931.1px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#606060] text-[12px] top-[-0.2px] w-[108px] whitespace-pre-wrap">Owner: John Smith</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="absolute h-[18px] left-0 top-[48px] w-[931.1px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#606060] text-[12px] top-[-0.2px]">john@gramercy.com</p>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="absolute h-[18px] left-0 top-[68px] w-[931.1px]" data-name="Paragraph">
...
function Container12() {
  return (
    <div className="content-stretch flex h-[86px] items-start justify-between relative shrink-0 w-full" data-name="Container">
      <Container13 />
      <Text1 />
    </div>
  );
...
function Paragraph9() {
  return (
    <div className="h-[18px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#606060] text-[12px] top-[-0.2px] w-[163px] whitespace-pre-wrap">📍 Jl. Sudirman 123, Jakarta</p>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101010] text-[14px] top-[-0.4px]">1,465</p>
    </div>
  );
}
...
function Paragraph13() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101010] text-[14px] top-[-0.4px] w-[56px] whitespace-pre-wrap">$45,231</p>
    </div>
  );
}
...
function Paragraph15() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101010] text-[14px] top-[-0.4px]">4.8 ⭐</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="bg-white h-[266px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
...
function Heading2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[164.863px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101010] text-[16px] top-[-0.6px]">Starbucks Borobudur</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#101010] text-[12px] top-[-0.2px]">4.9</p>
      </div>
    </div>
  );
}
...
function Container28() {
  return (
    <div className="h-[18px] relative shrink-0 w-[36.875px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center relative size-full">
        <Icon7 />
        <Text3 />
      </div>
...
function Container27() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[24px] items-center left-0 top-0 w-[922.063px]" data-name="Container">
      <Heading2 />
      <Container28 />
    </div>
  );
...
function Paragraph16() {
  return (
    <div className="absolute h-[18px] left-0 top-[28px] w-[922.063px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#606060] text-[12px] top-[-0.2px] w-[129px] whitespace-pre-wrap">Owner: Sarah Johnson</p>
    </div>
  );
}
...
function Paragraph17() {
  return (
    <div className="absolute h-[18px] left-0 top-[48px] w-[922.063px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#606060] text-[12px] top-[-0.2px]">sarah@starbucks.com</p>
    </div>
  );
}
...
function Paragraph18() {
  return (
    <div className="absolute h-[18px] left-0 top-[68px] w-[922.063px]" data-name="Paragraph">
...
function Paragraph19() {
  return (
    <div className="h-[18px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#606060] text-[12px] top-[-0.2px] w-[184px] whitespace-pre-wrap">📍 Jl. Gatot Subroto 45, Jakarta</p>
    </div>
  );
}
...
function Paragraph21() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101010] text-[14px] top-[-0.4px]">2,340</p>
    </div>
  );
}
...
function Paragraph23() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101010] text-[14px] top-[-0.4px] w-[55px] whitespace-pre-wrap">$65,120</p>
    </div>
  );
}
...
function Paragraph25() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101010] text-[14px] top-[-0.4px]">4.9 ⭐</p>
    </div>
  );
}
...
function Heading3() {
  return (
    <div className="h-[24px] relative shrink-0 w-[117.287px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101010] text-[16px] top-[-0.6px]">Baegopa Suhat</p>
      </div>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#101010] text-[12px] top-[-0.2px]">4.7</p>
      </div>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="h-[18px] relative shrink-0 w-[36.013px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center relative size-full">
        <Icon11 />
        <Text6 />
      </div>
...
function Paragraph26() {
  return (
    <div className="absolute h-[18px] left-0 top-[28px] w-[931.1px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#606060] text-[12px] top-[-0.2px] w-[110px] whitespace-pre-wrap">Owner: Mike Brown</p>
    </div>
  );
}
...
function Paragraph27() {
  return (
    <div className="absolute h-[18px] left-0 top-[48px] w-[931.1px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#606060] text-[12px] top-[-0.2px]">mike@baegopa.com</p>
    </div>
  );
}
...
function Paragraph29() {
  return (
    <div className="h-[18px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#606060] text-[12px] top-[-0.2px] w-[148px] whitespace-pre-wrap">📍 Jl. Thamrin 67, Jakarta</p>
    </div>
  );
}
...
function Paragraph31() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101010] text-[14px] top-[-0.4px]">987</p>
    </div>
  );
}
...
function Paragraph33() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101010] text-[14px] top-[-0.4px] w-[59px] whitespace-pre-wrap">$32,450</p>
    </div>
  );
}
...
function Paragraph35() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101010] text-[14px] top-[-0.4px]">4.7 ⭐</p>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="h-[24px] relative shrink-0 w-[125.375px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#101010] text-[16px] top-[-0.6px]">Old Burger Joint</p>
      </div>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="flex-[1_0_0] h-[18px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#101010] text-[12px] top-[-0.2px]">4.2</p>
      </div>
    </div>
  );
}
...
function Container64() {
  return (
    <div className="h-[18px] relative shrink-0 w-[36.7px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center relative size-full">
        <Icon15 />
        <Text10 />
      </div>
...
function Paragraph46() {
  return (
    <div className="absolute h-[18px] left-0 top-[28px] w-[922.063px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#606060] text-[12px] top-[-0.2px] w-[110px] whitespace-pre-wrap">Owner: Tom Wilson</p>
    </div>
  );
}
...
function Paragraph47() {
  return (
    <div className="absolute h-[18px] left-0 top-[48px] w-[922.063px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#606060] text-[12px] top-[-0.2px]">tom@burger.com</p>
    </div>
  );
}
...
function Paragraph49() {
  return (
    <div className="h-[18px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#606060] text-[12px] top-[-0.2px] w-[153px] whitespace-pre-wrap">📍 Jl. Merdeka 89, Jakarta</p>
    </div>
  );
}
...
function Paragraph51() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101010] text-[14px] top-[-0.4px]">456</p>
    </div>
  );
}
...
function Paragraph53() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101010] text-[14px] top-[-0.4px] w-[57px] whitespace-pre-wrap">$12,340</p>
    </div>
  );
}
...
function Paragraph55() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#101010] text-[14px] top-[-0.4px]">4.2 ⭐</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[1402.2px] items-start relative shrink-0 w-full" data-name="Container">
      <Container11 />
      <Container24 />
      <Container37 />
      <Container50 />
...
function Container5() {
  return (
    <div className="h-[1527.8px] relative shrink-0 w-full" data-name="Container">
...
function PQ() {
  return (
    <div className="bg-[#f5f5f5] content-stretch flex flex-col h-[1873.8px] items-start relative shrink-0 w-full" data-name="pQ">
      <Container />
      <Container1 />
      <Container5 />
    </div>
...
function Container73() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[34px] items-start left-0 pt-[21px] px-[469px] top-[1839.6px] w-[1072px]" data-name="Container">
      <Container74 />
    </div>
  );
}
